...
class RequestController extends Controller
{
    ...
    public function accept(Request $request, $fromUserId)
    {
        ...
        Notification::create([
         ...
         // Send remote push notification to original requester
        ExpoPushService::sendToUser(
            $fromUserId,
            "Request Accepted! ❤️",
            "{$currentDisplayName} has accepted your request!",
            [
                'screen' => 'ChatDetail',
                'params' => [
                    'userId' => $currentId,
                    'user'   => ['id' => $currentId, 'name' => $currentDisplayName],
                ],
            ]
        );
    ...
    public function decline(Request $request, $fromUserId)
    {
        ...
        $currentDisplayName = $currentUser->display_name ?: $currentUser->name;
        $declineMsg = "{$currentDisplayName} has declined your request.";
