...
class DatePlannerController extends Controller
{
    ...
    public function createProposal(Request $request)
    {
        ...
        $proposalMsg = "{$proposerName} invited you on a date at {$restaurantName}!";
        ...
        // Send remote push notification to partner
    ...
    public function respondProposal(Request $request)
    {
        ...
        // Send remote push notification to proposer
        $pushTitle = $newStatus === 'accepted' ? "Date Proposal Accepted! 🎉" : "Date Proposal Update";
        ExpoPushService::sendToUser(
            $booking->proposer_id,
            $pushTitle,
            $msg,
